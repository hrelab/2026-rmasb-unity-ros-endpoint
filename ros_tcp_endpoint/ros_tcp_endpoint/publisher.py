...
#  Modified by Jono Jenkens, 2026-02-06: Store message class in self.msg for consistency with subscriber and topic-type reporting.
#
...
class RosPublisher(RosSender):
    ...
    def __init__(self, topic, message_class, queue_size=10, latch=False):
        ...
        self.msg = message_class         # This was an instance message_class() before, not sure why
